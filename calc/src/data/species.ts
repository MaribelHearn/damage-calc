...
const SS_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  // Fundex
	...
	Flandre: {
		types: ['Dark', 'Fire'],
		bs: {hp: 50, at: 130, df: 85, sa: 120, sd: 85, sp: 90},
		weightkg: 45,
		abilities: {0: 'Hustle'},
	},
	Cell: {
		types: ['Ghost', 'Normal'],
		bs: {hp: 50, at: 140, df: 50, sa: 155, sd: 50, sp: 30},
		weightkg: 1,
		abilities: {0: 'Laser Mouth'},
	},
	Dennis: {
		types: ['Dark', 'Electric'],
		bs: {hp: 100, at: 95, df: 62, sa: 115, sd: 123, sp: 40},
		weightkg: 90,
		abilities: {0: 'Intimidate'},
	...
	Zalgo: {
		types: ['???'],
		bs: {hp: 79, at: 113, df: 71, sa: 127, sd: 71, sp: 109},
		weightkg: 90,
		abilities: {0: 'Intimidate'},
	},
	2012: {
		types: ['Fighting', 'Flying'],
		bs: {hp: 75, at: 150, df: 55, sa: 150, sd: 55, sp: 115},
		weightkg: 847,
		abilities: {0: 'Desolate Land'},
	},
	ROFLcopter: {
		types: ['Steel', 'Flying'],
		bs: {hp: 70, at: 86, df: 106, sa: 96, sd: 47, sp: 125},
		weightkg: 150,
		abilities: {0: 'Full Metal Body'},
	},
	Andross: {
		types: ['Rock', 'Poison'],
		bs: {hp: 100, at: 120, df: 125, sa: 60, sd: 80, sp: 40},
		weightkg: 1155,
		abilities: {0: 'Levitate'},
	},
	Slenderman: {
		types: ['Ghost'],
		bs: {hp: 50, at: 104, df: 90, sa: 50, sd: 104, sp: 102},
		weightkg: 90,
		abilities: {0: 'Rock Head'},
	},
	Marisa: {
		types: ['Electric', 'Flying'],
		bs: {hp: 85, at: 70, df: 70, sa: 125, sd: 90, sp: 100},
		weightkg: 45,
		abilities: {0: 'Magician'},
	},
	Luigi: {
		types: ['Grass', 'Electric'],
		bs: {hp: 110, at: 100, df: 80, sa: 80, sd: 80, sp: 70},
		weightkg: 45,
		abilities: {0: 'Negative Zone'},
	...
	Matrix: {
		types: ['Grass', 'Dragon'],
		bs: {hp: 90, at: 117, df: 90, sa: 117, sd: 80, sp: 106},
		weightkg: 90,
		abilities: {0: 'Clear Body'},
	},
	'Soviet Mudkip': {
	...
	'Lily White': {
		types: ['Fairy'],
		bs: {hp: 120, at: 60, df: 100, sa: 60, sd: 100, sp: 60},
		weightkg: 45,
		abilities: {0: 'Spring Fragrance'},
	},
	'Lolwut Pear': {
		types: ['Ground', 'Poison'],
		bs: {hp: 114, at: 77, df: 107, sa: 53, sd: 93, sp: 66},
		weightkg: 45,
		abilities: {0: 'Thick Fat'},
	},
	Cirno: {
	...
	Leonidas: {
		types: ['Fighting'],
		bs: {hp: 70, at: 135, df: 90, sa: 55, sd: 55, sp: 101},
		weightkg: 90,
		abilities: {0: 'Defiant'},
	},
	'King Harkinian': {
	...
	Yarrow: {
		types: ['Rock'],
		bs: {hp: 100, at: 100, df: 95, sa: 40, sd: 50, sp: 20},
		weightkg: 250,
		abilities: {0: 'Battle Armor'},
	},
	Doomsday: {
		types: ['Rock'],
		bs: {hp: 125, at: 140, df: 115, sa: 70, sd: 70, sp: 20},
		weightkg: 350,
		abilities: {0: 'Battle Armor'},
	},
	Vegeta: {
		types: ['Dragon', 'Fighting'],
		bs: {hp: 79, at: 100, df: 85, sa: 120, sd: 75, sp: 81},
		weightkg: 90,
		abilities: {0: 'Rivalry'},
	...
	'Dr. Octogonapus': {
		types: ['Psychic', 'Flying'],
		bs: {hp: 87, at: 67, df: 97, sa: 107, sd: 77, sp: 105},
		weightkg: 90,
		abilities: {0: 'Mega Launcher'},
	},
	'Ace Trainer': {
	...
	'Crasher Wake': {
		types: ['Water'],
		bs: {hp: 100, at: 90, df: 110, sa: 160, sd: 110, sp: 100},
		weightkg: 90,
		abilities: {0: 'Truant'},
	...
	Utsuho: {
		types: ['Fire', 'Flying'],
		bs: {hp: 85, at: 95, df: 40, sa: 160, sd: 65, sp: 85},
		weightkg: 45,
		abilities: {0: 'Immunity'},
	},
  Yuyuko: {
	...
	Ganondorf: {
		types: ['Dark', 'Fighting'],
		bs: {hp: 100, at: 140, df: 90, sa: 90, sd: 80, sp: 30},
		weightkg: 150,
		abilities: {0: 'Iron Fist'},
		otherFormes: ['Ganon'],
	},
	...
	Suiseiseki: {
		types: ['Normal', 'Grass'],
		bs: {hp: 62, at: 41, df: 91, sa: 101, sd: 111, sp: 109},
		weightkg: 45,
		abilities: {0: 'Keen Eye'},
	},
	'Admiral Ackbar': {
		types: ['Water'],
		bs: {hp: 80, at: 77, df: 97, sa: 101, sd: 80, sp: 100},
		weightkg: 90,
		abilities: {0: 'Anticipation'},
	},
	Yoda: {
	...
	'Darth Vader': {
		types: ['Dark'],
		bs: {hp: 90, at: 110, df: 85, sa: 120, sd: 60, sp: 70},
		weightkg: 90,
		abilities: {0: 'Rivalry'},
	},
	Longcat: {
	...
	Cats: {
		types: ['Electric'],
		bs: {hp: 80, at: 90, df: 60, sa: 107, sd: 103, sp: 90},
		weightkg: 90,
		abilities: {0: 'Imposing'},
	},
	'Raptor Jesus': {
		types: ['Dragon'],
		bs: {hp: 110, at: 100, df: 84, sa: 101, sd: 105, sp: 80},
		weightkg: 90,
		abilities: {0: 'Dragon\'s Maw'},
	},
	'Leeroy Jenkins': {
	...
	Remilia: {
		types: ['Dark', 'Flying'],
		bs: {hp: 85, at: 115, df: 60, sa: 115, sd: 60, sp: 120},
		weightkg: 45,
		abilities: {0: 'Frisk'},
	},
	'Angry Bird': {
		types: ['Normal', 'Flying'],
		bs: {hp: 70, at: 90, df: 65, sa: 35, sd: 60, sp: 80},
		weightkg: 45,
		abilities: {0: 'Anger Point'},
	},
	'Big Brother': {
		types: ['Normal', 'Flying'],
		bs: {hp: 130, at: 130, df: 80, sa: 65, sd: 75, sp: 60},
		weightkg: 90,
		abilities: {0: 'Justified'},
	},
	'Giant Enemy Crab': {
		types: ['Ground'],
		bs: {hp: 105, at: 115, df: 120, sa: 70, sd: 75, sp: 35},
		weightkg: 1337,
		abilities: {0: 'Sturdy'},
	},
	Tabuu: {
		types: ['Bug', 'Psychic'],
		bs: {hp: 100, at: 106, df: 100, sa: 154, sd: 120, sp: 100},
		weightkg: 1,
		abilities: {0: 'Long Reach'},
	},
	Sakuya: {
		types: ['Ice', 'Steel'],
		bs: {hp: 85, at: 90, df: 105, sa: 50, sd: 85, sp: 105},
		weightkg: 45,
		abilities: {0: 'Skill Link'},
	},
	'Super Nerd': {
	...
	Wriggle: {
		types: ['Bug'],
		bs: {hp: 80, at: 95, df: 95, sa: 45, sd: 70, sp: 105},
		weightkg: 45,
		abilities: {0: 'Swarm'},
	},
	'Leon Powalski': {
		types: ['Dragon', 'Poison'],
		bs: {hp: 127, at: 101, df: 89, sa: 144, sd: 97, sp: 42},
		weightkg: 45,
		abilities: {0: 'Filter'},
	},
	Trollface: {
		types: ['Dark'],
		bs: {hp: 110, at: 70, df: 126, sa: 65, sd: 96, sp: 33},
		weightkg: 45,
		abilities: {0: 'Pressure'},
	},
	Eirin: {
		types: ['Water', 'Poison'],
		bs: {hp: 150, at: 95, df: 50, sa: 95, sd: 80, sp: 70},
		weightkg: 45,
		abilities: {0: 'Healer'},
	},
	Kaguya: {
		types: ['Grass', 'Psychic'],
		bs: {hp: 210, at: 45, df: 25, sa: 85, sd: 100, sp: 65},
		weightkg: 45,
		abilities: {0: 'Regenerator'},
	},
	Tenshi: {
		types: ['Ground', 'Rock'],
		bs: {hp: 80, at: 100, df: 120, sa: 70, sd: 100, sp: 70},
		weightkg: 45,
		abilities: {0: 'Air Lock'},
	},
	Suika: {
		types: ['Rock', 'Fighting'],
		bs: {hp: 140, at: 130, df: 60, sa: 70, sd: 60, sp: 80},
		weightkg: 45,
		abilities: {0: 'White Smoke'},
	},
	Letty: {
		types: ['Ice', 'Rock'],
		bs: {hp: 90, at: 70, df: 100, sa: 90, sd: 115, sp: 60},
		weightkg: 45,
		abilities: {0: 'Snow Warning'},
	},
	Keine: {
		types: ['Steel'],
		bs: {hp: 80, at: 60, df: 80, sa: 110, sd: 100, sp: 80},
		weightkg: 45,
		abilities: {0: 'Inner Focus'},
	...
	'Keine-Hakutaku': {
		types: ['Steel', 'Ground'],
		bs: {hp: 80, at: 110, df: 100, sa: 60, sd: 70, sp: 90},
		weightkg: 45,
		abilities: {0: 'Inner Focus'},
		baseSpecies: 'Keine',
	},
	'S. A. Penguin': {
		types: ['Water', 'Ice'],
		bs: {hp: 96, at: 64, df: 88, sa: 107, sd: 66, sp: 86},
		weightkg: 45,
		abilities: {0: 'Big Pecks'},
	},
	'Advice God': {
	...
	'Missingno.-Ghost': {
		types: ['???', 'Ghost'],
		bs: {hp: 43, at: 61, df: 103, sa: 113, sd: 89, sp: 103},
		weightkg: 1590.8,
		abilities: {0: 'Mummy'},
	...
	'Missingno.-Kabutops': {
		types: ['???', 'Water'],
		bs: {hp: 67, at: 127, df: 113, sa: 53, sd: 79, sp: 73},
		weightkg: 1590.8,
		abilities: {0: 'Swift Swim'},
		baseSpecies: 'Missingno.',
	},
	'Missingno.-Aerodactyl': {
		types: ['???', 'Rock'],
		bs: {hp: 73, at: 101, df: 71, sa: 61, sd: 79, sp: 127},
		weightkg: 1590.8,
		abilities: {0: 'Rock Head'},
		baseSpecies: 'Missingno.',
	},
	'Missingno.-Yellow': {
		types: ['???', 'Electric'],
		bs: {hp: 179, at: 53, df: 41, sa: 101, sd: 107, sp: 31},
		weightkg: 1590.8,
		abilities: {0: 'Static'},
		baseSpecies: 'Missingno.',
	},
	Kirby: {
		types: ['Fairy'],
		bs: {hp: 110, at: 80, df: 80, sa: 80, sd: 80, sp: 50},
		weightkg: 15,
		abilities: {0: 'Cute Charm'},
	},
	'Meta Knight': {
		types: ['Fairy', 'Steel'],
		bs: {hp: 50, at: 110, df: 110, sa: 50, sd: 50, sp: 110},
		weightkg: 15,
		abilities: {0: 'Battle Armor'},
	},
	'King Dedede': {
	...
	Snake: {
		types: ['Ground'],
		bs: {hp: 84, at: 105, df: 110, sa: 65, sd: 70, sp: 91},
		weightkg: 90,
	...
	'Zeeky H. Bomb': {
		types: ['Normal'],
		bs: {hp: 70, at: 255, df: 60, sa: 50, sd: 60, sp: 55},
		weightkg: 45,
		abilities: {0: 'Huge Power'},
	},
  Yumemi: {
	...
	Engineer: {
		types: ['Rock'],
		bs: {hp: 80, at: 90, df: 125, sa: 50, sd: 80, sp: 80},
		weightkg: 90,
		abilities: {0: 'Technician'},
	},
	Mokou: {
		types: ['Fire'],
		bs: {hp: 110, at: 120, df: 84, sa: 80, sd: 60, sp: 76},
		weightkg: 45,
		abilities: {0: 'Conflagrate'},
	},
	Yuugi: {
		types: ['Ground', 'Fighting'],
		bs: {hp: 90, at: 160, df: 160, sa: 20, sd: 40, sp: 45},
		weightkg: 45,
		abilities: {0: 'Defiant'},
	},
	Komachi: {
		types: ['Water', 'Ghost'],
		bs: {hp: 120, at: 115, df: 85, sa: 70, sd: 70, sp: 70},
		weightkg: 45,
		abilities: {0: 'Own Tempo'},
	},
	Eiki: {
		types: ['Steel', 'Psychic'],
		bs: {hp: 90, at: 70, df: 85, sa: 110, sd: 100, sp: 80},
		weightkg: 45,
		abilities: {0: 'Pressure'},
	},
	'Phoenix Wright': {
		types: ['Normal', 'Fighting'],
		bs: {hp: 85, at: 105, df: 120, sa: 45, sd: 60, sp: 95},
		weightkg: 45,
		abilities: {0: 'Magic Guard'},
	},
	'Rick Astley': {
	...
	Zero: {
		types: ['Dark', 'Poison'],
		bs: {hp: 115, at: 75, df: 85, sa: 125, sd: 85, sp: 45},
		weightkg: 150,
		abilities: {0: 'Levitate'},
	},
	'Zero-Two': {
		types: ['Fairy', 'Poison'],
		bs: {hp: 115, at: 75, df: 85, sa: 85, sd: 125, sp: 45},
		weightkg: 150,
		abilities: {0: 'Levitate'},
	},
	Veteran: {
	...
	Yukari: {
		types: ['Psychic'],
		bs: {hp: 100, at: 60, df: 80, sa: 125, sd: 115, sp: 70},
		weightkg: 45,
		abilities: {0: 'Filter'},
	},
	Yamame: {
		types: ['Bug', 'Ground'],
		bs: {hp: 80, at: 100, df: 100, sa: 55, sd: 80, sp: 90},
		weightkg: 45,
		abilities: {0: 'Compound Eyes'},
	},
	Iku: {
		types: ['Electric', 'Dragon'],
		bs: {hp: 95, at: 75, df: 80, sa: 130, sd: 100, sp: 50},
		weightkg: 45,
		abilities: {0: 'Lightning Rod'},
	},
	Medicine: {
		types: ['Poison', 'Grass'],
		bs: {hp: 75, at: 75, df: 105, sa: 85, sd: 100, sp: 80},
		weightkg: 45,
		abilities: {0: 'Poison Touch'},
	},
	Yuuka: {
		types: ['Grass'],
		bs: {hp: 105, at: 120, df: 65, sa: 125, sd: 90, sp: 30},
		weightkg: 45,
		abilities: {0: 'Intimidate'},
	},
	Hibachi: {
	...
	'Evaccania DOOM': {
		types: ['Bug', 'Flying'],
		bs: {hp: 80, at: 115, df: 80, sa: 115, sd: 80, sp: 110},
		weightkg: 25,
		abilities: {0: 'Wonder Skin'},
	},
	Minoriko: {
		types: ['Grass', 'Ground'],
		bs: {hp: 115, at: 65, df: 95, sa: 80, sd: 100, sp: 60},
		weightkg: 45,
		abilities: {0: 'Natural Cure'},
	},
	Shizuha: {
		types: ['Grass', 'Ground'],
		bs: {hp: 110, at: 60, df: 60, sa: 115, sd: 75, sp: 90},
		weightkg: 45,
		abilities: {0: 'Chlorophyll'},
	},
	Alice: {
		types: ['Psychic', 'Ice'],
		bs: {hp: 90, at: 70, df: 85, sa: 110, sd: 105, sp: 65},
		weightkg: 45,
		abilities: {0: 'Wonderland'},
	},
	'Baby Bowser': {
		types: ['Fire', 'Dragon'],
		bs: {hp: 60, at: 80, df: 60, sa: 70, sd: 60, sp: 60},
		weightkg: 45,
		abilities: {0: 'Shell Armor'},
	},
	Bowser: {
		types: ['Fire', 'Dragon'],
		bs: {hp: 90, at: 120, df: 130, sa: 80, sd: 60, sp: 60},
		weightkg: 150,
		abilities: {0: 'Shell Armor'},
	...
	Genjii: {
		types: ['Rock', 'Flying'],
		bs: {hp: 70, at: 70, df: 200, sa: 30, sd: 70, sp: 10},
		weightkg: 45,
		abilities: {0: 'Shell Armor'},
	},
	VIVIT: {
	...
	Kogasa: {
		types: ['Ghost'],
		bs: {hp: 80, at: 110, df: 105, sa: 65, sd: 80, sp: 70},
		weightkg: 45,
		abilities: {0: 'Intimidate'},
	},
	Meiling: {
		types: ['Fighting', 'Grass'],
		bs: {hp: 100, at: 110, df: 110, sa: 45, sd: 70, sp: 90},
		weightkg: 45,
		abilities: {0: 'Guts'},
	},
	Patchouli: {
		types: ['Psychic'],
		bs: {hp: 30, at: 20, df: 75, sa: 150, sd: 180, sp: 45},
		weightkg: 45,
		abilities: {0: 'Trace'},
	},
	Suwako: {
		types: ['Water', 'Ground'],
		bs: {hp: 80, at: 85, df: 95, sa: 110, sd: 110, sp: 70},
		weightkg: 45,
		abilities: {0: 'Rain Dish'},
	},
	Tesla: {
		types: ['Electric'],
		bs: {hp: 100, at: 80, df: 100, sa: 134, sd: 100, sp: 86},
		weightkg: 90,
		abilities: {0: 'Volt Absorb'},
	},
	Shingyoku: {
	...
	Sariel: {
		types: ['Psychic', 'Flying'],
		bs: {hp: 100, at: 120, df: 100, sa: 125, sd: 100, sp: 135},
		weightkg: 45,
		abilities: {0: 'Pressure'},
	},
	'Serpent of Chaos': {
		types: ['Poison', 'Dark'],
		bs: {hp: 150, at: 120, df: 80, sa: 120, sd: 80, sp: 50},
		weightkg: 90,
		abilities: {0: 'Intimidate'},
	},
	'*** WINNER ***': {
		types: ['???'],
		bs: {hp: 115, at: 120, df: 115, sa: 120, sd: 115, sp: 115},
		weightkg: 150,
		abilities: {0: 'Victory Star'},
	},
	Satori: {
		types: ['Psychic'],
		bs: {hp: 100, at: 80, df: 105, sa: 100, sd: 105, sp: 35},
		weightkg: 45,
		abilities: {0: 'Synchronize'},
	},
	Koishi: {
		types: ['Normal'],
		bs: {hp: 90, at: 75, df: 85, sa: 140, sd: 65, sp: 85},
		weightkg: 45,
		abilities: {0: 'Infiltrator'},
	},
	Nitori: {
		types: ['Water', 'Grass'],
		bs: {hp: 75, at: 115, df: 70, sa: 100, sd: 90, sp: 80},
		weightkg: 45,
		abilities: {0: 'Swift Swim'},
	},
	Byakuren: {
		types: ['Psychic', 'Fighting'],
		bs: {hp: 90, at: 95, df: 115, sa: 80, sd: 75, sp: 80},
		weightkg: 45,
		abilities: {0: 'Inner Focus'},
	},
	Nue: {
	...
	Ichirin: {
		types: ['Normal', 'Fighting'],
		bs: {hp: 100, at: 55, df: 80, sa: 85, sd: 80, sp: 60},
		weightkg: 45,
		abilities: {0: 'Pure Power'},
	},
	'Nyan Cat': {
	...
	Mario: {
		types: ['Fire', 'Fighting'],
		bs: {hp: 80, at: 110, df: 80, sa: 100, sd: 70, sp: 80},
		weightkg: 90,
		abilities: {0: 'Vital Spirit'},
	...
	Bouldergeist: {
		types: ['Ghost', 'Rock'],
		bs: {hp: 80, at: 92, df: 130, sa: 70, sd: 98, sp: 70},
		weightkg: 150,
		abilities: {0: 'Rock Head'},
	},
	GLaDOS: {
		types: ['Steel', 'Poison'],
		bs: {hp: 90, at: 70, df: 130, sa: 120, sd: 80, sp: 30},
		weightkg: 250,
		abilities: {0: 'Neutralizing Gas'},
	},
	'Bad EGG': {
	...
	Wiggler: {
		types: ['Bug', 'Grass'],
		bs: {hp: 90, at: 100, df: 100, sa: 35, sd: 100, sp: 70},
		weightkg: 45,
		abilities: {0: 'Short-Tempered'},
		otherFormes: ['Angry Wiggler'],
	},
	'Angry Wiggler': {
		types: ['Bug', 'Grass'],
		bs: {hp: 90, at: 140, df: 60, sa: 35, sd: 60, sp: 110},
		weightkg: 45,
		abilities: {0: 'Short-Tempered'},
		baseSpecies: 'Angry Wiggler',
	},
	'Sunny Milk': {
		types: ['Fire', 'Fairy'],
		bs: {hp: 90, at: 60, df: 75, sa: 70, sd: 85, sp: 90},
		weightkg: 45,
		abilities: {0: 'Prankster'},
	},
	'Luna Child': {
		types: ['Electric', 'Fairy'],
		bs: {hp: 60, at: 55, df: 75, sa: 110, sd: 60, sp: 110},
		weightkg: 45,
		abilities: {0: 'Prankster'},
	},
	'Star Sapphire': {
		types: ['Water', 'Fairy'],
		bs: {hp: 65, at: 60, df: 95, sa: 75, sd: 100, sp: 75},
		weightkg: 45,
		abilities: {0: 'Prankster'},
	},
	Sanae: {
		types: ['Grass', 'Water'],
		bs: {hp: 90, at: 70, df: 110, sa: 85, sd: 110, sp: 70},
		weightkg: 45,
		abilities: {0: 'Serene Grace'},
	},
	Kanako: {
	...
	Ran: {
		types: ['Ground', 'Psychic'],
		bs: {hp: 82, at: 100, df: 70, sa: 100, sd: 70, sp: 108},
		weightkg: 45,
		abilities: {0: 'Inner Focus'},
	},
	Kanzou: {
		types: ['Ice', 'Flying'],
		bs: {hp: 70, at: 150, df: 80, sa: 130, sd: 80, sp: 90},
		weightkg: 90,
		abilities: {0: 'Hyper Cutter'},
	},
	Hagumanoki: {
		types: ['Bug'],
		bs: {hp: 69, at: 117, df: 85, sa: 77, sd: 85, sp: 57},
		weightkg: 45,
		abilities: {0: 'Compound Eyes'},
	},
	Ruscus: {
	...
	Ryuuguu: {
		types: ['Rock', 'Dragon'],
		bs: {hp: 110, at: 110, df: 100, sa: 110, sd: 60, sp: 50},
		weightkg: 150,
		abilities: {0: 'Pressure'},
	},
	Weepinmeleon: {
	...
	'Bloody Jitterbug': {
		types: ['Bug', 'Dark'],
		bs: {hp: 100, at: 59, df: 81, sa: 129, sd: 81, sp: 90},
		weightkg: 90,
		abilities: {0: 'Clear Body'},
	},
	...
	Chen: {
		types: ['Ground'],
		bs: {hp: 80, at: 100, df: 70, sa: 50, sd: 60, sp: 120},
		weightkg: 45,
		abilities: {0: 'Early Bird'},
	},
	Reisen: {
		types: ['Psychic', 'Poison'],
		bs: {hp: 90, at: 55, df: 90, sa: 100, sd: 95, sp: 90},
		weightkg: 45,
		abilities: {0: 'Keen Eye'},
	},
	Parsee: {
		types: ['Dark', 'Poison'],
		bs: {hp: 100, at: 65, df: 90, sa: 65, sd: 110, sp: 80},
		weightkg: 45,
		abilities: {0: 'Stench'},
	},
	Rin: {
		types: ['Fire', 'Ghost'],
		bs: {hp: 75, at: 105, df: 75, sa: 100, sd: 75, sp: 100},
		weightkg: 45,
		abilities: {0: 'Blaze'},
	},
	Daiyousei: {
		types: ['Grass', 'Fairy'],
		bs: {hp: 100, at: 36, df: 62, sa: 100, sd: 92, sp: 90},
		weightkg: 45,
		abilities: {0: 'Serene Grace'},
	},
	Konngara: {
		types: ['Fighting', 'Ghost'],
		bs: {hp: 100, at: 140, df: 120, sa: 100, sd: 120, sp: 100},
		weightkg: 45,
		abilities: {0: 'Pressure'},
	},
	Yumeko: {
		types: ['Steel'],
		bs: {hp: 80, at: 120, df: 100, sa: 70, sd: 75, sp: 75},
		weightkg: 45,
		abilities: {0: 'Keen Eye'},
	},
	Rumia: {
		types: ['Dark'],
		bs: {hp: 90, at: 140, df: 60, sa: 75, sd: 60, sp: 80},
		weightkg: 45,
		abilities: {0: 'Aftermath'},
	},
	Koakuma: {
		types: ['Psychic', 'Flying'],
		bs: {hp: 90, at: 50, df: 50, sa: 100, sd: 100, sp: 90},
		weightkg: 45,
		abilities: {0: 'Synchronize'},
	},
	Youmu: {
		types: ['Ghost', 'Steel'],
		bs: {hp: 80, at: 110, df: 125, sa: 50, sd: 70, sp: 85},
		weightkg: 45,
		abilities: {0: 'Inner Focus'},
	},
	Mystia: {
		types: ['Normal', 'Flying'],
		bs: {hp: 90, at: 85, df: 70, sa: 70, sd: 85, sp: 110},
		weightkg: 45,
		abilities: {0: 'Insomnia'},
	},
	Tewi: {
		types: ['Normal'],
		bs: {hp: 90, at: 75, df: 75, sa: 75, sd: 75, sp: 90},
		weightkg: 45,
		abilities: {0: 'Serene Grace'},
	},
	Aya: {
		types: ['Normal', 'Flying'],
		bs: {hp: 90, at: 90, df: 90, sa: 60, sd: 60, sp: 140},
		weightkg: 45,
		abilities: {0: 'Early Bird'},
	},
	Kisume: {
		types: ['Fire', 'Water'],
		bs: {hp: 60, at: 55, df: 150, sa: 70, sd: 60, sp: 75},
		weightkg: 45,
		abilities: {0: 'Shell Armor'},
	},
	'Chuck Testa': {
		types: ['Rock'],
		bs: {hp: 100, at: 100, df: 110, sa: 50, sd: 80, sp: 80},
		weightkg: 90,
